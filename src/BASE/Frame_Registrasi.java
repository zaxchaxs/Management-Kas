...
public class Frame_Registrasi extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        getContentPane().add(txtPASSWORD, new org.netbeans.lib.awtextra.AbsoluteConstraints(570, 402, 260, 30));
    ...
    if (nama.isEmpty() || nim.isEmpty() || username.isEmpty() || password.isEmpty()) {
        JOptionPane.showMessageDialog(this, "Semua kolom harus diisi!", "Peringatan", JOptionPane.WARNING_MESSAGE);
    } else {
        JOptionPane.showMessageDialog(this, "Pendaftaran berhasil!\nNama: " + nama + "\nNIM: " + nim, "Sukses", JOptionPane.INFORMATION_MESSAGE);
        // Reset input
        txtNAMA.setText("");
        txtNIM.setText("");
        txtUSERNAME.setText("");
   ...
   JOptionPane.showMessageDialog(this, "Kolom Password telah diisi.");
